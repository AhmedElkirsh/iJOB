    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @endif
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('job.search') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Find Jobs') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                @auth
                    ...
                    <div class="ms-3 relative">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-dropdown-link href="{{ view('candidate-profile') }}">
                                {{ __('Profile') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('jobs') }}" :active="request()->routeIs('jobs')">
                {{ __('jobs') }}
            <x-responsive-nav-link href="{{ route('job-search') }}" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
