...
<body>
    <h class="text-center">Edit Job</h1>
    <form class="m-auto w-50 border p-5" action="/jobs/{{$job->id}}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="industry" placeholder="Industry" name="industry" value="{{$job->industry}}">
        </div>
        @error('industry')
             <p class="alert alert-danger">{{$message}}</p>
         @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="description" placeholder="description" name="job_description" value="{{$job->job_description}}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="location" placeholder="location" name="location" value="{{$job->location}}">
        </div>
        @error('location')
             <p class="alert alert-danger">{{$message}}</p>
        @enderror
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="salary" placeholder="salary" name="salary" value="{{$job->salary}}">
        </div>
        @error('salary')
            <p class="alert alert-danger">{{$message}}</p>
        @enderror
